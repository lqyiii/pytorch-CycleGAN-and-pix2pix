...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize_W', type=int, default=300, help='scale images to this size')
        self.parser.add_argument('--loadSize_H', type=int, default=300, help='scale images to this size')
        self.parser.add_argument('--fineSize_W', type=int, default=256, help='then crop to this size')
        self.parser.add_argument('--fineSize_H', type=int, default=224, help='then crop to this size')
